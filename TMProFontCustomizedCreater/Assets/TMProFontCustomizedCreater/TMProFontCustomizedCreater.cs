...
public class TMProFontCustomizedCreater : EditorWindow
{
    ...
    static void Open()
    {
        GetWindow<TMProFontCustomizedCreater>();
    }

    private const string kFontFolderPath = "Assets/TextMesh Pro/Examples & Extras/Fonts";
    private const string kFontMaterialsFolderPath = "Assets/TextMesh Pro/Examples & Extras/Resources/Fonts & Materials";
